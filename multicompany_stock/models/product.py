...
class ProductProperty(models.TransientModel):
    ...
    def set_properties(self, object, properties=False):
        ...
        self.set_property(object, 'property_stock_procurement', self.property_stock_procurement.id, properties)
        self.set_property(object, 'property_stock_production', self.property_stock_production.id, properties)
        self.set_property(object, 'property_stock_inventory', self.property_stock_inventory.id, properties)
