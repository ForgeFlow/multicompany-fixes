...
class ResPartnerProperty(models.TransientModel):
    ...
    def set_properties(self, object, properties=False):
        ...
        self.set_property(object, 'property_stock_customer', self.property_stock_customer.id, properties)
        self.set_property(object, 'property_stock_supplier', self.property_stock_supplier.id, properties)
