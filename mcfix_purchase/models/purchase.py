    ...
    def onchange_partner_id(self):
        ...
        if self.partner_id:
            self.currency_id = (
                ...
                ).partner_id.property_purchase_currency_id.id
...
class PurchaseOrderLine(models.Model):
    ...
    invoice_lines = fields.One2many(check_company=True)
    ...
    def onchange_product_id(self):
        ...
        result = super(
            PurchaseOrderLine, self.with_context(not_display_company=True)
        ).onchange_product_id()
        return result
