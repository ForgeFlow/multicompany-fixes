...
class ProductProperty(models.TransientModel):
    ...
    def get_property_fields(self, object, properties):
        ...
        self.property_stock_account_input = self.get_property_value(
    ...
    def set_properties(self, object, properties=False):
        ...
        self.set_property(object, 'property_stock_account_input',
                          self.property_stock_account_input.id, properties)
        self.set_property(object, 'property_stock_account_output',
                          self.property_stock_account_output.id, properties)
