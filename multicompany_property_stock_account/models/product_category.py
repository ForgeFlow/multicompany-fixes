...
class ProductCategoryProperty(models.TransientModel):
    ...
    def get_property_fields(self, object, properties):
        super(ProductCategoryProperty, self).get_property_fields(
            object, properties)
        self.property_valuation = self.get_property_value(
            'property_valuation', object, properties)
        self.property_cost_method = self.get_property_value(
            'property_cost_method', object, properties)
        self.property_stock_journal = self.get_property_value(
            'property_stock_journal', object, properties)
        self.property_stock_account_input_categ_id = self.get_property_value(
            'property_stock_account_input_categ_id', object, properties)
        self.property_stock_account_output_categ_id = self.get_property_value(
    ...
    def set_properties(self, object, properties=False):
        ...
        self.set_property(object, 'property_valuation',
                          self.property_valuation, properties)
        self.set_property(object, 'property_cost_method',
                          self.property_cost_method, properties)
        self.set_property(object, 'property_stock_journal',
                          self.property_stock_journal.id, properties)
