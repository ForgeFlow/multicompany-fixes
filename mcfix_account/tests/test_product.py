...
class TestProduct(TransactionCase):
    def setUp(self):
        ...
        self.tax = self.tax_model.with_user(self.user).create(
            {"name": "Tax 1 - Test", "amount": 0.0, "company_id": self.company.id}
        )
    ...
    def test_template(self):
        ...
        self.tax_2 = self.tax_model.with_user(self.user).create(
            {"name": "Tax 2 - Test", "amount": 0.0, "company_id": self.company_2.id}
        )
