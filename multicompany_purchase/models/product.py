...
class ProductProperty(models.TransientModel):
    ...
    def get_property_fields(self, object, properties):
        ...
        self.property_account_creditor_price_difference = self.get_property_value('property_account_creditor_price_difference', object, properties)

    @api.model
    def set_properties(self, object, properties=False):
        super(ProductProperty, self).set_properties(object, properties)
        self.set_property(object, 'property_account_creditor_price_difference', self.property_account_creditor_price_difference.id, properties)
