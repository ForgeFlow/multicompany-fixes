...
class TestMulticompanyProperty(test_multicompany.TestMulticompanyProperty):
    ...
    def test_sync_partner_child_commercial_fields(self):
        ...
        self.assertEqual(
            self.partner.with_company(self.company_1.id).property_payment_term_id,
            self.payment_term_1,
        )
        self.assertEqual(
            self.partner.with_company(self.company_2.id).property_payment_term_id,
            self.payment_term_2,
        )
        self.assertEqual(
            self.child.with_company(self.company_1.id).property_payment_term_id,
            self.payment_term_1,
        )
        self.assertEqual(
            self.child.with_company(self.company_2.id).property_payment_term_id,
            self.payment_term_2,
        )
